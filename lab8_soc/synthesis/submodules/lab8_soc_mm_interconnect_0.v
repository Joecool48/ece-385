...
module lab8_soc_mm_interconnect_0 (
	...
	wire   [27:0] aes_aes_slave_agent_m0_address;                                                     // AES_AES_Slave_agent:m0_address -> AES_AES_Slave_translator:uav_address
	...
	wire  [104:0] aes_aes_slave_agent_rf_source_data;                                                 // AES_AES_Slave_agent:rf_source_data -> AES_AES_Slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] aes_aes_slave_agent_rsp_fifo_out_data;                                              // AES_AES_Slave_agent_rsp_fifo:out_data -> AES_AES_Slave_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> AES_AES_Slave_agent:cp_data
	...
	wire    [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> jtag_avalon_jtag_slave_agent:cp_channel
	...
	wire  [103:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	wire  [103:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> sdram_pll_pll_slave_agent:cp_data
	...
	wire  [103:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> sdram_s1_agent:cp_data
	...
	wire  [103:0] aes_aes_slave_agent_rp_data;                                                        // AES_AES_Slave_agent:rp_data -> router_002:sink_data
	...
	wire  [103:0] sysid_qsys_0_control_slave_agent_rp_data;                                           // sysid_qsys_0_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [103:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [103:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [103:0] cmd_demux_001_src3_data;                                                            // cmd_demux_001:src3_data -> cmd_mux_005:sink1_data
	...
	wire  [103:0] rsp_demux_005_src1_data;                                                            // rsp_demux_005:src1_data -> rsp_mux_001:sink3_data
	...
	wire  [103:0] cmd_demux_src6_data;                                                                // cmd_demux:src6_data -> crosser:in_data
	...
	wire  [103:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_006:sink0_data
	...
	wire  [103:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_006:sink1_data
	...
	wire  [103:0] rsp_demux_006_src0_data;                                                            // rsp_demux_006:src0_data -> crosser_002:in_data
	...
	wire  [103:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink6_data
	...
	wire  [103:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> crosser_003:in_data
	...
	lab8_soc_mm_interconnect_0_router_002 router_003 (
	...
	lab8_soc_mm_interconnect_0_router_004 router_004 (
	...
	lab8_soc_mm_interconnect_0_router_004 router_005 (
	...
	lab8_soc_mm_interconnect_0_router_004 router_006 (
	...
	lab8_soc_mm_interconnect_0_router_004 router_007 (
	...
	lab8_soc_mm_interconnect_0_router_004 router_008 (
	...
	lab8_soc_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (jtag_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (jtag_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (sdram_pll_c0_clk),                        //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
