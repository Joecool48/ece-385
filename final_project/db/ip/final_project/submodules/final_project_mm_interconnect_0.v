...
module final_project_mm_interconnect_0 (
		...
		input  wire [3:0]  master_template_0_avalon_master_byteenable,                      //                                                          .byteenable
		input  wire        master_template_0_avalon_master_read,                            //                                                          .read
		output wire [31:0] master_template_0_avalon_master_readdata,                        //                                                          .readdata
	...
	wire   [31:0] master_template_0_avalon_master_translator_avalon_universal_master_0_readdata;      // master_template_0_avalon_master_agent:av_readdata -> master_template_0_avalon_master_translator:uav_readdata
	...
	wire    [3:0] master_template_0_avalon_master_translator_avalon_universal_master_0_byteenable;    // master_template_0_avalon_master_translator:uav_byteenable -> master_template_0_avalon_master_agent:av_byteenable
	...
	wire   [31:0] master_template_0_avalon_master_translator_avalon_universal_master_0_writedata;     // master_template_0_avalon_master_translator:uav_writedata -> master_template_0_avalon_master_agent:av_writedata
	wire    [8:0] master_template_0_avalon_master_translator_avalon_universal_master_0_burstcount;    // master_template_0_avalon_master_translator:uav_burstcount -> master_template_0_avalon_master_agent:av_burstcount
	...
	wire  [113:0] master_template_0_avalon_master_agent_cp_data;                                      // master_template_0_avalon_master_agent:cp_data -> router:sink_data
	...
	wire  [113:0] router_src_data;                                                                    // router:src_data -> master_template_0_avalon_master_limiter:cmd_sink_data
	...
	wire  [113:0] master_template_0_avalon_master_limiter_cmd_src_data;                               // master_template_0_avalon_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          master_template_0_avalon_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> master_template_0_avalon_master_limiter:cmd_src_ready
	wire    [4:0] master_template_0_avalon_master_limiter_cmd_src_channel;                            // master_template_0_avalon_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire          master_template_0_avalon_master_limiter_cmd_src_startofpacket;                      // master_template_0_avalon_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire          master_template_0_avalon_master_limiter_cmd_src_endofpacket;                        // master_template_0_avalon_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire          rsp_mux_src_valid;                                                                  // rsp_mux:src_valid -> master_template_0_avalon_master_limiter:rsp_sink_valid
	wire  [113:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> master_template_0_avalon_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                                  // master_template_0_avalon_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [4:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> master_template_0_avalon_master_limiter:rsp_sink_channel
	wire          rsp_mux_src_startofpacket;                                                          // rsp_mux:src_startofpacket -> master_template_0_avalon_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_src_endofpacket;                                                            // rsp_mux:src_endofpacket -> master_template_0_avalon_master_limiter:rsp_sink_endofpacket
	...
	wire  [113:0] master_template_0_avalon_master_limiter_rsp_src_data;                               // master_template_0_avalon_master_limiter:rsp_src_data -> master_template_0_avalon_master_agent:rp_data
	...
	wire    [4:0] master_template_0_avalon_master_limiter_cmd_valid_data;                             // master_template_0_avalon_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire          jtag_game_nios_avalon_jtag_slave_agent_rdata_fifo_src_valid;                        // jtag_game_nios_avalon_jtag_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] jtag_game_nios_avalon_jtag_slave_agent_rdata_fifo_src_data;                         // jtag_game_nios_avalon_jtag_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          jtag_game_nios_avalon_jtag_slave_agent_rdata_fifo_src_ready;                        // avalon_st_adapter:in_0_ready -> jtag_game_nios_avalon_jtag_slave_agent:rdata_fifo_src_ready
	...
	altera_merlin_traffic_limiter #(
		...
		.cmd_src_valid          (master_template_0_avalon_master_limiter_cmd_valid_data)           // cmd_valid.data
	);
	...
	final_project_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_c0_clk),                                                      //        clk.clk
		.reset              (master_template_0_clock_reset_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
		.sink_ready         (master_template_0_avalon_master_limiter_cmd_src_ready),           //       sink.ready
		.sink_channel       (master_template_0_avalon_master_limiter_cmd_src_channel),         //           .channel
		.sink_data          (master_template_0_avalon_master_limiter_cmd_src_data),            //           .data
		.sink_startofpacket (master_template_0_avalon_master_limiter_cmd_src_startofpacket),   //           .startofpacket
		.sink_endofpacket   (master_template_0_avalon_master_limiter_cmd_src_endofpacket),     //           .endofpacket
		.sink_valid         (master_template_0_avalon_master_limiter_cmd_valid_data),          // sink_valid.data
	...
	final_project_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (jtag_game_nios_avalon_jtag_slave_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (jtag_game_nios_avalon_jtag_slave_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (jtag_game_nios_avalon_jtag_slave_agent_rdata_fifo_src_ready),     //         .ready
