...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../final_project.sopcinfo
...
# Design Name 
# setting SOPC_NAME is final_project
SOPC_NAME := final_project
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8000950
SOPC_SYSID_FLAG += --sidp=0x8000950
ELF_PATCH_FLAG  += --sidp 0x8000950

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1544487128
SOPC_SYSID_FLAG += --timestamp=1544487128
ELF_PATCH_FLAG  += --timestamp 1544487128
...
# setting hal.stderr is jtag_game_nios
ELF_PATCH_FLAG  += --stderr_dev jtag_game_nios

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_game_nios
ELF_PATCH_FLAG  += --stdin_dev jtag_game_nios
...
# setting hal.stdout is jtag_game_nios
ELF_PATCH_FLAG  += --stdout_dev jtag_game_nios
